  ...
  static class FirstThrow implements State {
    ...
    public int calcScore(
      ...
      if (isStrike(currentScore)) {
        result =
          calcFirstThrowBallScoreIfStrike(balls, currentScore, currentIndex);
        needsNextFrame = true;
      } else {
        isFirstScore = false;
      }
    ...
    private int calcFirstThrowBallScoreIfStrike(
      List<Integer> balls,
      int score,
      int currentIndex
    ) {
  ...
  static class SecondThrow implements State {
    ...
    public int calcScore(
      ...
      if (isSpare(balls, currentScore, currentIndex)) {
        result =
          calcSecondThrowBallScoreIfSpare(balls, currentScore, currentIndex);
      }
    ...
    private int calcSecondThrowBallScoreIfSpare(
      List<Integer> balls,
      int score,
      int currentIndex
    ) {
